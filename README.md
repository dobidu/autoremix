...
| Screen | Description |
|--------|-------------|
| ![Drop Zone](docs/screenshots/01_drop.png) | **Drop Zone**: drag a file or browse |
| ![Separating](docs/screenshots/02_separating.png) | **Separating**: 4-stem extraction in progress |
| ![Stems Ready](docs/screenshots/03_stem_ready.png) | **Stems Ready**: per-stem playback, mix, and drag-to-DAW |
| ![Mode Params](docs/screenshots/04_mode_params.png) | **Mode & Parameters**: choose style, tune remix settings |
| ![Render](docs/screenshots/05_render.png) | **Render**: waveform comparison, play original vs remix/mashup |
| ![Mashup](docs/screenshots/06_mashup.png) | **Mashup**: combine 2 tracks, two-column 8-stem mixer, 8 built-in templates |
